        ...
        <section className="container trip-cards">
          <SlideIn className="card-home orange-card">
            ...
            <p className="card-text">
              Cada integrante puede agregar o modificar actividades, ajustando
              el viaje según sus preferencias
            </p>
          ...
          <div className="right-column">
            <SlideIn delay={0.1} className="card-home gray-card full">
              ...
              <p className="card-text">
                Definí fechas, destinos, actividades y alojamiento. Todo el
                grupo puede ver y proponer cambios al instante
              </p>
            ...
            <div className="half-grid">
              <SlideIn delay={0.2} className="card-home gray-card">
                ...
                <p className="card-text">
                  Planifiquen sus paradas, lugares turísticos o ciudades
                  favoritas directamente en el itinerario
                </p>
                <GlobeHemisphereWest
                  size={32}
                  className="icon"
